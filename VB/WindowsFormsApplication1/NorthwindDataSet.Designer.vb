...
Namespace WindowsFormsApplication1.NorthwindDataSetTableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([CategoryName], [Description]) VALUES (@CategoryN" & "ame, @Description);" & Constants.vbCrLf & "SELECT CategoryID, CategoryName, Description FROM Categorie" & "s WHERE (CategoryID = SCOPE_IDENTITY())"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [CategoryName] = @CategoryName, [Description] = @Description WHERE (([CategoryID] = @Original_CategoryID) AND ([CategoryName] = @Original_CategoryName));" & ControlChars.CrLf & "SELECT CategoryID, CategoryName, Description FROM Categories WHERE (CategoryID = @CategoryID)"
		...
		Public Overridable Function Update(ByVal CategoryName As String, ByVal Description As String, ByVal Original_CategoryID As Integer, ByVal Original_CategoryName As String, ByVal CategoryID As Integer) As Integer
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(4).Value = (CInt(Fix(CategoryID)))
